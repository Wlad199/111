(() => {
    ...
    (() => {
        ...
        let script_parent = document.querySelector(".ask-questions");
        let menuItem = script_parent.querySelectorAll(".ask-questions__item");
        script_parent.addEventListener("click", (event => {
            ...
            if (target.classList.contains("ask-questions__item")) {
                for (let i = 0; i < menuItem.length; i++) menuItem[i].classList.remove("_active");
        ...
        const script_element = document.querySelectorAll(".item-question");
        ...
        script_element[0].addEventListener("click", showBlock01);
        script_element[1].addEventListener("click", showBlock02);
        script_element[2].addEventListener("click", showBlock03);
        ...
        paren.addEventListener("click", (event => {
            ...
            if (target.classList.contains("ask-item")) {
                for (let i = 0; i < askItem.length; i++) askItem[i].classList.remove("_active");
                target.classList.add("_active");
            }
        }));
